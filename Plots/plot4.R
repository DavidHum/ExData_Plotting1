...
#Generate plot 4
par(mfrow = c(2,2))
plot(y = Power$Global_active_power, x = dias, type = "l", ylab= "Global Active Power", 
     xlab= "")

plot(y = Power$Voltage, x = dias, type = "l", ylab= "Voltage", xlab= "datetime")
...
plot(y = Power$Global_reactive_power, x = dias, type = "l", ylab= "Global Reactive Power", 
     xlab= "datetime")
...
plot(y = Power$Global_reactive_power, x = dias, type = "l", ylab= "Global_reactive_power", 
     xlab= "datetime")
